        ...
        <div>
            ...
            <footer className="p-8 bg-gray-200">
                <div className="text-center">
                    <b className="text-xl font-bold">A Competitive Fashion World</b>
                    <h3 className="text-2xl font-bold mt-2">Why Choose Denim and Devils for Your Style?</h3>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8  ">
                    <div className="w-full md:w-1/3 p-4">
                        <b className="text-xl font-bold">Who We Are?</b>
                        <h3 className="text-2xl font-bold mt-2">Professionals with Years of Experience in This Field</h3>
                    ...
                    <div className="new-container">
                        <b className="text-xl font-bold">Our Services</b>
                        <h3 className="text-2xl font-bold mt-2">Comprehensive Fabric Care Services</h3>
                        <p className="mt-4 text-gray-700 ">
